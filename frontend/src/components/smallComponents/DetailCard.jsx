...
const DetailCard = ({cardIcon, cardTitle, cardText}) => {
  return (
    <div className=' flex flex-col gap-4 w-full h-auto bg-gray-100 p-6 rounded-2xl max-w-80 min-h-68 hover:translate-y-[-10px] hover:shadow-2xl transition-all duration-500 hover:bg-blue-100 border-4 border-transparent hover:border-blue-600 '>
