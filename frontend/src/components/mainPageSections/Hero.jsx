    ...
    <section id="Hero" className='flex flex-col lg:flex-row justify-around items-center min-h-screen w-full p-8 mt-30 lg:mt-0 xl:pl-24 '>
       <div className='flex flex-col justify-center items-center text-center p-4 gap-6 lg:gap-8 md:max-w-[70%] lg:max-w-[60%] xl:max-w-[40%]'>
        <div className="flex flex-col gap-3 md:gap-4 lg:gap-5">
          <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl  font-bold">Visualize, Modele, Gere <span className="bg-linear-to-r from-black to-purple-900 bg-clip-text text-transparent font-black">Terraform</span></h1>
          <h3 className="text-lg lg:text-xl xl:text-2xl font-normal text-gray-800">Construa sua Infraestrutura como <span className="font-black text-purple-900" >Código</span> a partir de um diagrama visual. Sem cadastro, sem complicação.</h3>
        </div>
