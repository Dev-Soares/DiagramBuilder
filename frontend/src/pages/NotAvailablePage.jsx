        ...
        <main className='w-full h-screen block lg:hidden flex flex-col justify-center items-center gap-4 p-4'>
            <div className='flex flex-col justify-center items-center text-center p-4 gap-6 lg:gap-8 md:max-w-[70%] lg:max-w-[60%] xl:max-w-[40%]'>
                <div className="flex flex-col gap-3 md:gap-4 lg:gap-5">
                    <span className="material-symbols-outlined !text-8xl text-purple-700">mimo_disconnect</span>
                    ...
                    <h3 className="text-md md:text-lg lg:text-xl text-purple-700 font-semibold">Clique abaixo para retornar à página principal</h3>
                </div>

                <button onClick={() => navigate('/')} className="w-[55%] md:w-[45%] lg:w-[70%] 2xl:w-[50%]  bg-gradient-to-br from-purple-600 to-purple-950 text-white font-bold p-3 px-4  rounded-4xl md:text-lg xl:text-xl flex justify-center items-center gap-4 cursor-pointer hover:translate-y-[-2px] hover:scale-[1.02]  transform transition-all duration-400 " >  Retornar <span className="material-symbols-outlined"> arrow_forward </span></button>
            </div>
        </main>
    )
}
